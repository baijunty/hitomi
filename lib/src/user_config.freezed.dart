...
mixin _$UserConfig {
 ...
 String get output; int get maxTasks; List<String> get languages; String get proxy; List<List<FilterLabel>> get excludes; String get dateLimit; String get auth; String get logLevel; String get logOutput; String get aiTagPath; String get remoteHttp; double get threshold;
...
@useResult
$Res call({
 String output, int maxTasks, List<String> languages, String proxy, List<List<FilterLabel>> excludes, String dateLimit, String auth, String logLevel, String logOutput, String aiTagPath, String remoteHttp, double threshold
});
...
/// Create a copy of UserConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? output = null,Object? maxTasks = null,Object? languages = null,Object? proxy = null,Object? excludes = null,Object? dateLimit = null,Object? auth = null,Object? logLevel = null,Object? logOutput = null,Object? aiTagPath = null,Object? remoteHttp = null,Object? threshold = null,}) {
...
as String,aiTagPath: null == aiTagPath ? _self.aiTagPath : aiTagPath // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String output,  int maxTasks,  List<String> languages,  String proxy,  List<List<FilterLabel>> excludes,  String dateLimit,  String auth,  String logLevel,  String logOutput,  String aiTagPath,  String remoteHttp,  double threshold)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserConfig() when $default != null:
return $default(_that.output,_that.maxTasks,_that.languages,_that.proxy,_that.excludes,_that.dateLimit,_that.auth,_that.logLevel,_that.logOutput,_that.aiTagPath,_that.remoteHttp,_that.threshold);case _:
  return orElse();
...
class _UserConfig implements UserConfig {
   _UserConfig(this.output, {this.maxTasks = 5, final  List<String> languages = const ["japanese", "chinese"], this.proxy = "", final  List<List<FilterLabel>> excludes = const [], this.dateLimit = "2013-01-01", this.auth = "12345678", this.logLevel = "debug", this.logOutput = "", this.aiTagPath = "", this.remoteHttp = "127.0.0.1:7890", this.threshold = 0.72}): _languages = languages,_excludes = excludes;
...
@override@JsonKey() final  String aiTagPath;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,output,maxTasks,const DeepCollectionEquality().hash(_languages),proxy,const DeepCollectionEquality().hash(_excludes),dateLimit,auth,logLevel,logOutput,aiTagPath,remoteHttp,threshold);
...
/// Create a copy of UserConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? output = null,Object? maxTasks = null,Object? languages = null,Object? proxy = null,Object? excludes = null,Object? dateLimit = null,Object? auth = null,Object? logLevel = null,Object? logOutput = null,Object? aiTagPath = null,Object? remoteHttp = null,Object? threshold = null,}) {
