...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( T data,  int totalCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DataResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( T data,  int totalCount)  $default,) {final _that = this;
switch (_that) {
case _DataResponse():
return $default(_that.data,_that.totalCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( T data,  int totalCount)?  $default,) {final _that = this;
switch (_that) {
case _DataResponse() when $default != null:
return $default(_that.data,_that.totalCount);case _:
  return null;
...
/// Create a copy of DataResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? data = freezed,Object? totalCount = null,}) {
